...
public class CardUpdateController extends MyController2 implements MyController1, Initializable{
	@FXML
	...
	public void Submit(ActionEvent event) {
		Card card = new Card();
		card.setCardNo(oldCard.getCardNo());
		...
		if(!DaoFactory.getCard().update(card)) {
	...
	public void setValue(Object object) {
		oldCard = (Card)object;
		Mail.setText(myUtil.getString(oldCard.getMail()));
		Phone.setText(myUtil.getString(oldCard.getPhone()));
		CardNo.setText(myUtil.Number2String(oldCard.getCardNo()));
		CardName.setText(myUtil.getString(oldCard.getCardName()));
